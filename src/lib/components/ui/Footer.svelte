<footer class="w-full flex flex-row justify-between items-center bg-accent/20 border-t-2 backdrop-blur-2xl px-20 py-5 text-[#ABABAB]">
    ...
    <a href="https://github.com/nokokiii/geoglider" target="_blank" class="flex flex-row items-center gap-4">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 32 32" class="fill-[#ABABAB] hover:fill-white transition-colors duration-300">
        ...
        <p>
            Made with <span class="text-red-500">❤</span> by nokokiii
        </p>
    </a>
</footer>
